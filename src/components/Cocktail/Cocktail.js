...
const Cocktail = ({cocktail}) => {
    ...
    return (
        <div className='mb-5 bg-gray-300 ml-5 mt-5 flex mr-5'>
            ...
            <button className= 'text-gray-800 border-slate-900 border-solid border-2 bg-slate-300 hover:bg-gray-800 hover:text-white sm:mt-3 sm:ml-32 px-3 rounded-full py-2'>Purchase</button>
            </div>
        </div>
        </div>
    );
